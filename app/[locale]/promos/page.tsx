...
import { IPromosLandingPage } from '@/lib/generated';
...
export default async function SlugPage(props: BlogPageProps) {
  const { params } = props;
  ...
  const urlPath = '/promos';

  return <SharedPageLayout urlPath={urlPath} pageContentTypeUID="promos_landing_page" />;
}
...
export async function generateMetadata(props: BlogPageProps): Promise<Metadata> {
  ...
  try {
    const page = await getPage<IPromosLandingPage>(urlPath, 'promos_landing_page');
