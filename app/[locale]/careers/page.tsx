...
export default async function SlugPage(props: CareerPageProps) {
  ...
  const urlPath = `/careers`;

  return (
    <SharedPageLayout urlPath={urlPath}>
      {resolvedSearchParams.jobId && <Job jobId={resolvedSearchParams.jobId}></Job>}
    </SharedPageLayout>
  );
}
