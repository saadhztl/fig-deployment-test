    ...
    return (
      <div className={cn(wrapperClassName)}>
        ...
        <input
          ...
          className={cn(
            'w-full py-[15px] px-[16px] border-1 border-[#bff300] rounded-[6px] text-white font-[500] bg-transparent placeholder:text-[#9CA3AF] outline-none focus:border-white cursor-pointer',
            className,
